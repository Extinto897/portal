...
if (mysqli_num_rows($result) == 0) {
    die("La tabla 'productos' no existe en la base de datos 'clientes & suenos'. Verifique el nombre de la tabla.");
}
...
if (isset($_POST['actualizar_producto'])) {
    ...
    if ($id > 0) {
        ...
        $mensaje_producto = "<p style='color:red;'>Error: ID de producto no válido.</p>";
    }
}
        ...
        <table>
            ...
            <?php while ($producto = mysqli_fetch_assoc($result_productos)): ?>
                <tr>
                    ...
                    <td><a href="admin_tienda.php?id_producto=<?php echo htmlspecialchars($producto['id']); ?>" class="edit-link">Editar</a></td>
                </tr>
            <?php endwhile; ?>
        </table>
    <?php else: ?>
